#' @title Perform Nucleotide to Nucleotide BLAST Searches (BLASTN)
#' @description Run nucleotide to nucleotide BLAST of reference sequences
...
blast_nucleotide_to_nucleotide <- function(query, 
                          subject,
                          strand = "both",
                          output.path = NULL,
                          is.subject.db = FALSE,
    ...
    message("Starting 'blastn -task ", task,"' with  query: ", query, " and subject: ",subject," using ", cores, " core(s) ...")
